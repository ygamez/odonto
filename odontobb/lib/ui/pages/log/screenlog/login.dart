...
class Loginstarter extends StatefulWidget {
  const Loginstarter({Key? key}) : super(key: key);

  @override
  _LoginstarterState createState() => _LoginstarterState();
}

class _LoginstarterState extends State<Loginstarter> with RegisterAuth {
  // get email => null;
  // get password => null;
